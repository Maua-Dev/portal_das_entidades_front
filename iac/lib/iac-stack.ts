...
export class IacStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const s3Bucket = new s3.Bucket(this, 'PortalDasEntidadesFrontBucket' + stage, {
      versioned: true,
    ...
    const oac = new cloudfront.CfnOriginAccessControl(this, 'AOC', {
      originAccessControlConfig: {
        name: 'PortalDasEntidades Front Bucket OAC ' + stage,
    ...
    if (stage === 'dev' || stage === 'homolog' || stage === 'prod') {
      viewerCertificate = cloudfront.ViewerCertificate.fromAcmCertificate(
        Certificate.fromCertificateArn(
          this,
          'PortalDasEntidadesFrontCertificate-' + stage,
          acmCertificateArn
        ),
        {
    ...
    const cloudFrontWebDistribution = new cloudfront.CloudFrontWebDistribution(
      ...
      'CDN',
      {
        comment: 'PortalDasEntidades Front Distribution ' + stage,
        originConfigs: [
          {
            s3OriginSource: {
    ...
    new cdk.CfnOutput(this, 'PortalDasEntidadesFrontBucketName-' + stage, {
      value: s3Bucket.bucketName
    })

    new cdk.CfnOutput(this, 'PortalDasEntidadesFrontDistributionId-' + stage, {
      value: cloudFrontWebDistribution.distributionId
    })

    new cdk.CfnOutput(this, 'PortalDasEntidadesFrontDistributionDomainName-' + stage, {
